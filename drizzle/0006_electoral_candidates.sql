...
ALTER TABLE "electoral_candidates" ADD CONSTRAINT "electoral_candidates_snapshot_run_id_electoral_sync_runs_sync_run_id_fk" FOREIGN KEY ("snapshot_run_id") REFERENCES "public"."electoral_sync_runs"("sync_run_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "electoral_sync_runs_latest_idx" ON "electoral_sync_runs" USING btree ("election_year","status","extracted_at");--> statement-breakpoint
